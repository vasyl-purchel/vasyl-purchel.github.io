...
// Where to push generated pages
let githubUser     = "vasyl-purchel"
let githubUserPage = sprintf "%s.github.io" githubUser
let githubLink     = sprintf "git@github.com:%s/%s.git" githubUser githubUserPage
